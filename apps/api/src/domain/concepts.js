...
const DISHES = [
  ...
  ['pizza', 'Pizza', ['pizzas', 'margherita', 'pizza margherita', 'cheese pizza', 'pepperoni pizza', 'pepperoni', 'sourdough pizza', 'pizzeria'], 'italian'],
  ...
  ['udon', 'Udon', ['udon noodles', 'yaki udon'], 'japanese'],
  ['gyoza', 'Gyoza', ['pork dumplings', 'potstickers'], 'japanese'],
  ['sushi', 'Sushi', ['nigiri', 'maki', 'sashimi', 'sushi rolls'], 'japanese'],
  ['katsu-curry', 'Katsu curry', ['chicken katsu', 'katsu'], 'japanese'],
  ['teriyaki', 'Teriyaki', ['chicken teriyaki', 'salmon teriyaki'], 'japanese'],
  ['tempura', 'Tempura', ['prawn tempura', 'vegetable tempura'], 'japanese'],
  ['chow-mein', 'Chow mein', ['stir fried noodles', 'stir-fried noodles', 'lo mein', 'chicken chow mein', 'singapore noodles'], 'chinese'],
  ['fried-rice', 'Fried rice', ['egg fried rice', 'special fried rice'], 'chinese'],
  ['sweet-and-sour', 'Sweet and sour', ['sweet and sour chicken', 'sweet and sour pork', 'sweet n sour'], 'chinese'],
  ['crispy-duck', 'Crispy duck', ['peking duck', 'aromatic duck', 'duck pancakes'], 'chinese'],
  ['dim-sum', 'Dim sum', ['dumplings', 'bao', 'bao buns', 'har gow', 'siu mai', 'steamed buns'], 'chinese'],
  ['kung-pao', 'Kung pao chicken', ['kung po', 'gong bao'], 'chinese'],
  ['spring-rolls', 'Spring rolls', ['egg rolls', 'prawn crackers and spring rolls'], 'chinese'],
  ['wonton-soup', 'Wonton soup', ['wontons', 'won ton'], 'chinese'],
  ['bibimbap', 'Bibimbap', [], 'korean'],
  ['bulgogi', 'Bulgogi', ['korean bbq beef'], 'korean'],
  ['korean-fried-chicken', 'Korean fried chicken', ['kfc chicken', 'yangnyeom'], 'korean'],
  ['kimchi', 'Kimchi', ['kimchi stew', 'kimchi jjigae'], 'korean'],
  ['pad-thai', 'Pad thai', ['phad thai'], 'thai'],
  ['green-curry', 'Thai green curry', ['green curry'], 'thai'],
  ['red-curry', 'Thai red curry', ['red curry'], 'thai'],
  ['massaman', 'Massaman curry', ['massaman'], 'thai'],
  ['tom-yum', 'Tom yum', ['tom yum soup', 'tom kha'], 'thai'],
  ['pho', 'Pho', ['phở', 'beef pho'], 'vietnamese'],
  ['banh-mi', 'Bánh mì', ['banh mi'], 'vietnamese'],
  ['summer-rolls', 'Summer rolls', ['rice paper rolls', 'fresh rolls'], 'vietnamese'],
  ['bun-cha', 'Bún chả', ['bun cha', 'vermicelli bowl', 'bun bowl'], 'vietnamese'],
  ...
  ['pie', 'Pie', ['steak pie', 'steak and ale pie', 'chicken pie', 'pie and mash'], 'british'],
  ['bangers-and-mash', 'Bangers and mash', ['sausage and mash', 'sausages'], 'british'],
  ['sticky-toffee-pudding', 'Sticky toffee pudding', ['sticky toffee'], 'british'],
  ['afternoon-tea', 'Afternoon tea', ['cream tea', 'scones'], 'cafe'],
  ...
  ['tacos', 'Tacos', ['taco', 'carnitas tacos', 'carnitas', 'fish tacos', 'street tacos'], 'mexican'],
  ['burrito', 'Burrito', ['burritos'], 'mexican'],
  ['quesadilla', 'Quesadilla', ['quesadillas'], 'mexican'],
  ['nachos', 'Nachos', [], 'mexican'],
  ['paella', 'Paella', ['seafood paella'], 'spanish'],
  ['patatas-bravas', 'Patatas bravas', ['bravas'], 'spanish'],
  ['croquetas', 'Croquetas', ['croquettes'], 'spanish'],
  ['tortilla', 'Spanish tortilla', ['tortilla espanola', 'spanish omelette'], 'spanish'],
  ['jamon', 'Jamón', ['jamon', 'iberico ham', 'charcuterie'], 'spanish'],
  ['steak-frites', 'Steak frites', [], 'french'],
  ['french-onion-soup', 'French onion soup', ['onion soup'], 'french'],
  ['croque-monsieur', 'Croque monsieur', ['croque madame'], 'french'],
  ['confit-duck', 'Confit duck', ['duck confit'], 'french'],
  ['crepes', 'Crêpes', ['crepes', 'crepe', 'galette'], 'french'],
  ...
  ['calamari', 'Calamari', ['fried squid', 'squid'], 'seafood'],
  ['grilled-fish', 'Grilled fish', ['whole fish', 'fish of the day', 'catch of the day', 'sea bass'], 'seafood'],
  ...
  ['souvlaki', 'Souvlaki', ['gyros', 'gyro', 'greek kebab'], 'mediterranean'],
  ['moussaka', 'Moussaka', [], 'mediterranean'],
  ['halloumi', 'Halloumi', ['grilled halloumi'], 'mediterranean'],
  ...
  ['korma', 'Korma', ['chicken korma'], 'indian'],
  ['tandoori', 'Tandoori', ['tandoori chicken', 'tikka', 'chicken tikka'], 'indian'],
  ['rogan-josh', 'Rogan josh', ['lamb rogan josh'], 'indian'],
  ['saag', 'Saag', ['saag paneer', 'palak paneer', 'paneer'], 'indian'],
  ['samosa', 'Samosa', ['samosas', 'pakora', 'bhaji', 'onion bhaji'], 'indian'],
  ['naan', 'Naan', ['naan bread', 'garlic naan', 'roti'], 'indian'],
  ...
  ['hot-dog', 'Hot dog', ['hot dogs', 'chilli dog'], 'american'],
  ['cheesecake', 'Cheesecake', [], 'american'],
...
const CUISINES = [
  ...
  ['japanese', 'Japanese', []],
  ['chinese', 'Chinese', ['cantonese', 'szechuan', 'sichuan', 'chinese food', 'chinese takeaway']],
  ['thai', 'Thai', []],
...
const INGREDIENTS = [
  ...
  ['noodles', 'Noodles', ['noodle', 'noodle dishes', 'noodle bar']],
...
const STYLE_HINTS = {
  'style:healthy-food': { dishes: ['salad', 'soup', 'falafel', 'mezze', 'avocado-toast', 'hummus', 'ceviche', 'sushi', 'pho', 'summer-rolls', 'grilled-fish', 'bibimbap', 'halloumi'], cuisines: ['vegetarian', 'vegan', 'mediterranean', 'salad', 'juice', 'health', 'japanese', 'vietnamese'] },
  'style:fried-food': { dishes: ['fried-chicken', 'korean-fried-chicken', 'fish-and-chips', 'chips', 'burger', 'nachos', 'spring-rolls', 'calamari', 'tempura', 'samosa'], cuisines: ['fast food', 'fried chicken', 'chicken', 'burger', 'fish and chips', 'chip shop', 'kebab'] , styles: ['fast-food'] },
  'style:spicy-food': { dishes: ['arrabbiata', 'green-curry', 'red-curry', 'tom-yum', 'kung-pao', 'kimchi', 'korean-fried-chicken', 'rogan-josh', 'tikka-masala', 'biryani', 'shawarma', 'tacos', 'pad-thai'], cuisines: ['thai', 'indian', 'mexican', 'szechuan', 'sichuan', 'korean', 'peruvian', 'caribbean'] },
  'style:light-food': { dishes: ['salad', 'soup', 'mezze', 'sushi', 'avocado-toast', 'flat-white'], cuisines: ['cafe', 'tapas', 'mediterranean', 'japanese'] },
  'style:comfort-food': { dishes: ['mac-and-cheese', 'lasagne', 'sunday-roast', 'fish-pie', 'pie', 'bangers-and-mash', 'burger', 'pancakes', 'full-breakfast'], cuisines: ['british', 'american', 'diner', 'pub'] },
  'style:fine-dining': { dishes: [], cuisines: ['fine dining', 'french', 'steakhouse'] },
  'style:sharing-plates': { dishes: ['mezze', 'nachos', 'gyoza', 'dim-sum', 'patatas-bravas', 'croquetas', 'jamon'], cuisines: ['tapas', 'spanish', 'mediterranean', 'dim sum', 'korean'] },
  'style:kids-menu': { dishes: ['pizza', 'chips', 'pancakes', 'ice-cream', 'chow-mein', 'fried-rice', 'sweet-and-sour', 'katsu-curry'], cuisines: ['pizza', 'diner', 'american'] },
  ...
  'style:sweet-treats': { dishes: ['tiramisu', 'ice-cream', 'cinnamon-bun', 'croissant', 'pancakes', 'waffles', 'hot-chocolate', 'milkshake', 'crepes', 'sticky-toffee-pudding', 'cheesecake', 'afternoon-tea'], cuisines: ['bakery', 'cafe', 'dessert', 'ice cream', 'patisserie'] },
};
...
export function browseVocabulary() {
  ...
  return {
    food: [
      ...
      { title: 'Styles', hint: 'How you like to eat — expand one for the dishes it usually means.',
        items: CONCEPTS.filter((c) => c.kind === 'style').map((c) => ({ key: c.key, label: c.label, children: pick('dish', STYLE_HINTS[c.key]?.dishes ?? []) })) },
